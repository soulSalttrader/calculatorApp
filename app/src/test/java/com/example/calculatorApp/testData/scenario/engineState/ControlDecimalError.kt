...
object ControlDecimalError : EngineState.Control {

    override val buildInput = { context: ContextEngineState -> buildControlInputState<ContextEngineState.Error>(context) }
    override val buildExpected = { context: ContextEngineState -> buildControlExpectedState<ContextEngineState.Error>(context) }
    ...
    override fun buildContexts(
        ...
        val input = ContextEngineState.Error(
            ...
            lastOperand = Double.NaN.toString(),
